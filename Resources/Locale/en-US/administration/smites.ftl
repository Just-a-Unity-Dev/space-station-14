...
admin-smite-plasma-internals-description = Replaces the contents of their internals with phoron.
...
admin-trick-internals-refill-plasma-description = Refills phoron in the target tank or target's internals.
